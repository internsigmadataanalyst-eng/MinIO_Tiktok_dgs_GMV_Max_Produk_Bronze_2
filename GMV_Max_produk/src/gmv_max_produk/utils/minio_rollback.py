# src/gmv_max_produk/utils/minio_rollback.py
...
or via this module:
    python -m src.gmv_max_produk.utils.minio_rollback --enable-versioning
...
def _cli_client(args) -> tuple[Minio, str]:
    if args.endpoint or args.access or args.secret or args.bucket:
        ...
        from src.gmv_max_produk.utils.minio_client import get_minio_client
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not bucket_versioning_enabled(client, bucket):
        ...
        print("  python -m src.gmv_max_produk.utils.minio_rollback --enable-versioning")
        return 2
